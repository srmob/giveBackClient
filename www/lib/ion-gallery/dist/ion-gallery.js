(function () {
  ...
  ionGallery.$inject = ['$ionicPlatform', 'ionGalleryHelper', 'ionGalleryConfig','$state'];
...
(function(){
  ...
  function ionSlider($ionicModal,ionGalleryHelper,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function link(scope, element, attrs) {
      var _modal;
      console.log('scope object is'+JSON.stringify(scope.ionGalleryItems));
      ...
      scope.openModal = function() {
          console.log('modal shown'+element+JSON.stringify(scope.ionGalleryItems));
